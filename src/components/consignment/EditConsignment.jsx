...
const EditConsignment = ({
    ...
    useEffect(() => {
        ...
        const editConsignmentData = {
            ...
            farmerId: consignment.farmerId?._id || consignment.farmerId,
            transporterId: consignment.transporterId?._id || consignment.transporterId,
        };
    ...
    const onFinish = async (values) => {
        try {
            const response = await api.request('put', `/api/consignment/${consignment._id}`, values);
            console.log('Consignment edited:', response);
            onCancel();
            fetchConsignments();
        } catch (error) {
